        ...
        <footer className="footer">
            ...
            <div className="social">
                ...
                <div className="icons">
                            ...
                            <div className='follow-us'><h3>Follows us</h3></div>
                        </div>
                        <div className="foot-cols">
                            ...
                            <div className="foot-col">
                                <div className="contact">
                                        <i className="fa fa-handshake-o" aria-hidden="true" style={{ color: 'rgb(202, 52, 53)', scale: '1.4' }}></i>
                                    ...
                                    <div className="contact-info">
                                        <div className="contact-item">
                                            ...
                                            <div className="contact-details">
                                                <h3 className="foot-head" >Rahul Kashyap</h3>
                                                <ul className="list">
                                                    <li>(President)</li>
                                                        <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="tel:+918574613029" className='anchor'>+91 8574613029</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div className="contact-item">
                                            <i className="fa fa-user-o" aria-hidden="true" ></i>
                                            <div className="contact-details">
                                                <h3 className="foot-head" >Ashutosh Kumar Singh Rathore</h3>
                                                <ul className="list">
                                                    ...
                                                    <li>
                                                        <i className="fa fa-phone"></i>
                                                        <a href="tel:+916396277108" className='anchor'>+91 6396277108</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
